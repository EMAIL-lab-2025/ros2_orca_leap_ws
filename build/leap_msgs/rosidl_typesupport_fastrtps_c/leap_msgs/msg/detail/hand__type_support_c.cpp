...
#include "leap_msgs/msg/detail/hand__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // normal, velocity
#include "leap_msgs/msg/detail/arm__functions.h"  // arm
#include "leap_msgs/msg/detail/finger__functions.h"  // fingers
...
size_t get_serialized_size_leap_msgs__msg__Finger(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_leap_msgs__msg__Finger(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, leap_msgs, msg, Finger)();


using _Hand__ros_msg_type = leap_msgs__msg__Hand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: fingers
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, leap_msgs, msg, Finger
      )()->data);
  ...
  // Field name: arm
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, leap_msgs, msg, Arm
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->arm, cdr))
    {
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: fingers
  {
    ...
    if (ros_message->fingers.data) {
      leap_msgs__msg__Finger__Sequence__fini(&ros_message->fingers);
    }
...
size_t get_serialized_size_leap_msgs__msg__Hand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Hand__ros_msg_type * ros_message = static_cast<const _Hand__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name fingers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_leap_msgs__msg__Finger(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name arm

  current_alignment += get_serialized_size_leap_msgs__msg__Arm(
...
static uint32_t _Hand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_leap_msgs__msg__Hand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_leap_msgs
size_t max_serialized_size_leap_msgs__msg__Hand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: fingers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_leap_msgs__msg__Finger(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: arm
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_leap_msgs__msg__Arm(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = leap_msgs__msg__Hand;
    is_plain =
      (
...
static size_t _Hand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_leap_msgs__msg__Hand(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, leap_msgs, msg, Hand)() {
